...
void read_mesh_file(Mesh_t *mesh)
{
    ...
    if (is_parallel)
    {
        ...
        dims[0] = partition->n_partition_cells;
        offset[0] = rank;
        count[0] = 1;
        dims[1] = 0;
        offset[1] = 0;
        ...
        dims[0] = partition->n_partition_boundaries;
        offset[0] = rank;
        count[0] = 1;
        dims[1] = 0;
        offset[1] = 0;
        ...
        dims[0] = partition->n_partition_faces;
        offset[0] = rank;
        count[0] = 1;
        dims[1] = 0;
        offset[1] = 0;
        ...
        dims[0] = partition->n_partition_sends;
        offset[0] = rank;
        count[0] = 1;
        dims[1] = 0;
        offset[1] = 0;
        ...
        dims[0] = partition->n_partition_receives;
        offset[0] = rank;
        count[0] = 1;
        dims[1] = 0;
        offset[1] = 0;
